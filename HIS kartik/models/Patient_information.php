...
class Patient_information extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            ['address1', 'match', 'pattern' => '/^[A-Za-z0-9.-\s,]+$/i', 'message' => 'Address cannot contain special symbol, only can contain "." and ","'],
            ['address2', 'match', 'pattern' => '/^[A-Za-z0-9.-\s,]+$/i', 'message' => 'Address cannot contain special symbol, only can contain "." and ","'],
            ['address3', 'match', 'pattern' => '/^[A-Za-z0-9.-\s,]+$/i', 'message' => 'Address cannot contain special symbol, only can contain "." and ","'],
            [['first_reg_date'], 'safe'],
          //  [['nric'], 'integer'],
