...
class Report_16b extends Report{
	protected $name = 'report_16b';
	//protected $pdf;
	//protected $csv;
	//protected $searchMinInclusive; //assumed is date
	//protected $searchMaxInclusive; //assumed is date
	//protected $generateDate;
	protected $storedProcedureName = 'report_16b'; //Enter just 'report1_query' if //CALL report1_query(:startDate, :endDate) // leave :startDate... as is 
