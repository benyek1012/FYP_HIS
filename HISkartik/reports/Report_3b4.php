...
class Report_3b4 extends Report{
	protected $name = 'report_3b4';
	//protected $pdf;
	//protected $csv;
	//protected $searchMinInclusive; //assumed is date
	//protected $searchMaxInclusive; //assumed is date
	//protected $generateDate;
	protected $storedProcedureName = 'report_3b4'; //Enter just 'report1_query' if //CALL report1_query(:startDate, :endDate) // leave :startDate... as is 
