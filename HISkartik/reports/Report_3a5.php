...
class Report_3a5 extends Report{
	protected $name = 'report_3a5';
	//protected $pdf;
	//protected $csv;
	//protected $searchMinInclusive; //assumed is date
	//protected $searchMaxInclusive; //assumed is date
	//protected $generateDate;
	protected $storedProcedureName = 'report_3a5'; //Enter just 'report1_query' if //CALL report1_query(:startDate, :endDate) // leave :startDate... as is 
